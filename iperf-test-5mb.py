...
def run():
    ...
    info(net['r1'].cmd("tc qdisc add dev r1-eth0 parent 1:1 handle 10: tbf rate 100mbit burst 75kb limit 5mb"))

    info(net['r1'].cmd("tc qdisc add dev r1-eth1 root handle 1:0 netem latency 30ms"))
    info(net['r1'].cmd("tc qdisc add dev r1-eth1 parent 1:1 handle 10: tbf rate 100mbit burst 75kb limit 5mb"))
    
    info(net['r1'].cmd("tc qdisc add dev r1-eth2 root handle 1:0 netem latency 30ms"))
    info(net['r1'].cmd("tc qdisc add dev r1-eth2 parent 1:1 handle 10: tbf rate 100mbit burst 75kb limit 5mb"))
    
    info(net['r2'].cmd("tc qdisc add dev r2-eth0 root handle 1:0 netem latency 30ms"))
    info(net['r2'].cmd("tc qdisc add dev r2-eth0 parent 1:1 handle 10: tbf rate 100mbit burst 75kb limit 5mb"))

    info(net['r2'].cmd("tc qdisc add dev r2-eth1 root handle 1:0 netem latency 30ms"))
    info(net['r2'].cmd("tc qdisc add dev r2-eth1 parent 1:1 handle 10: tbf rate 100mbit burst 75kb limit 5mb"))
    
    info(net['r3'].cmd("tc qdisc add dev r3-eth0 root handle 1:0 netem latency 30ms"))
    info(net['r3'].cmd("tc qdisc add dev r3-eth0 parent 1:1 handle 10: tbf rate 100mbit burst 75kb limit 5mb"))
    
    info(net['r3'].cmd("tc qdisc add dev r3-eth1 root handle 1:0 netem latency 30ms"))
    info(net['r3'].cmd("tc qdisc add dev r3-eth1 parent 1:1 handle 10: tbf rate 100mbit burst 75kb limit 5mb"))
    
    info(net['r4'].cmd("tc qdisc add dev r4-eth0 root handle 1:0 netem latency 30ms"))
    info(net['r4'].cmd("tc qdisc add dev r4-eth0 parent 1:1 handle 10: tbf rate 100mbit burst 75kb limit 5mb"))

    info(net['r4'].cmd("tc qdisc add dev r4-eth1 root handle 1:0 netem latency 30ms"))
    info(net['r4'].cmd("tc qdisc add dev r4-eth1 parent 1:1 handle 10: tbf rate 100mbit burst 75kb limit 5mb"))
    
    info(net['r4'].cmd("tc qdisc add dev r4-eth2 root handle 1:0 netem latency 30ms"))
    info(net['r4'].cmd("tc qdisc add dev r4-eth2 parent 1:1 handle 10: tbf rate 100mbit burst 75kb limit 5mb")) 
